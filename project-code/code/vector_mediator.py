...
@nb.jit(nopython=True, cache=True)
def M2_gen_ss(s, t, m1, m2, m3, m4, vert, m_X2, m_Gamma_X2):
    m12 = m1*m1
    m13 = m1*m12
    m14 = m12*m12
    m15 = m12*m13
...
# Cross-sections for each process el, tr, gen
...
if __name__ == '__main__':
    ...
    m2 = m_d
    s_min = (m1 + m2)**2
    S = 10**(np.linspace(np.log10(s_min), 1, int(1e3)))
    ...
    plot_M2 = ax1.contourf(s, t, np.log10(M2_general_tHoft), levels=300, cmap='jet')
