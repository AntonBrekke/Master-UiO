...
def C_n(T_a, T_d, xi_d, xi_phi):
    ...
    C_da_dd = C_res_scalar.C_34_12(0, 1., -1., m_d, m_d, m_d, m_a, k_d, k_d, k_d, k_a, T_d, T_d, T_d, T_a, xi_d, xi_d, xi_d, 0., vert_tr, m_phi2, m_Gamma_phi2) / 2.
    C_aa_da = C_res_scalar.C_34_12(0, 1., -1., m_d, m_a, m_a, m_a, k_d, k_a, k_a, k_a, T_d, T_a, T_a, T_a, xi_d, 0., 0., 0., vert_fi, m_phi2, m_Gamma_phi2) / 2.
    print("C_ns:", C_da, 2.*C_aa, C_da_dd, C_aa_da, 2.*C_pp_dd)
    return C_da + 2.*C_aa + C_da_dd + C_aa_da + 2.*C_pp_dd
# rho = rho_d + rho_phi
def C_rho(T_a, T_d, xi_d, xi_phi):
    ...
    C_da_dd = C_res_scalar.C_34_12(4, 1., -1., m_d, m_d, m_d, m_a, k_d, k_d, k_d, k_a, T_d, T_d, T_d, T_a, xi_d, xi_d, xi_d, 0., vert_tr, m_phi2, m_Gamma_phi2) / 2.
    C_aa_da = C_res_scalar.C_34_12(1, 1., -1., m_d, m_a, m_a, m_a, k_d, k_a, k_a, k_a, T_d, T_a, T_a, T_a, xi_d, 0., 0., 0., vert_fi, m_phi2, m_Gamma_phi2) / 2.
    print("C_rhos:", C_da, C_aa, C_da_dd, C_aa_da)
    return C_da + C_aa + C_da_dd + C_aa_da
def C_xi0(T_a, T_d, xi_d, xi_phi):
    C_pp_dd = C_res_scalar.C_n_pp_dd(m_d, m_phi, k_d, k_phi, T_d, xi_d, xi_phi, vert_el, type=1) / 4.
    return 2.*C_pp_dd
