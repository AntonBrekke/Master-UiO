...
def ker_C_n_pp_dd_s_t_integral_new(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_phi, vert):
    ...
    m_phi10 = m_phi4*m_phi6
    m_phi12 = m_phi6*m_phi6
    m_phi14 = m_phi6*m_phi8
    t_add = m_d2 + m_phi2
    ...
    int_tmax = 2*((np.sqrt(a*(t_max-t_m)*(t_max-t_p))*(-8*m_phi6+4*(-3*m_d2+3*s+t_max+t_m+t_p)*m_phi4-2*(3*m_d4-2*(3*s+t_max+t_m+t_p)*m_d2+3*s2+t_max*t_m+t_max*t_p+t_m*t_p+2*s*(t_max+t_m+t_p))*m_phi2-2*m_d6+s3+s2*t_max+s2*t_m+s*t_max*t_m+s2*t_p+s*t_max*t_p+s*t_m*t_p+2*t_max*t_m*t_p+m_d4*(3*s+2*(t_max+t_m+t_p))-m_d2*(3*s2+2*(t_max+t_m+t_p)*s+2*t_m*t_p+2*t_max*(t_m+t_p)))*(m_phi2-4*m_d2)**2)/(a*(t_max-m_d2)*(-2*m_phi2-m_d2+s+t_max)*(t_m-m_d2)*(-2*m_phi2-m_d2+s+t_m)*(t_p-m_d2)*(-2*m_phi2-m_d2+s+t_p))+(1/(2*np.sqrt(a)*(2*m_phi2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)))*((4*m_d2-2*(t_m+t_p))*m_phi6+(-20*m_d4+(4*(t_m+t_p)-2*s)*m_d2+12*t_m*t_p+s*(t_m+t_p))*m_phi4+8*(4*m_d2+s)*(m_d4-t_m*t_p)*m_phi2-2*(32*m_d8-32*(t_m+t_p)*m_d6+(-s2+8*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(s*(t_m+t_p)-16*t_m*t_p)*m_d2-s2*t_m*t_p))*np.log(m_d2-t_max)-((40*m_phi8-2*(10*m_d2+36*s+11*(t_m+t_p))*m_phi6+(-468*m_d4+6*(23*s+6*(t_m+t_p))*m_d2+50*s2+12*t_m*t_p+27*s*(t_m+t_p))*m_phi4-4*(88*m_d6-6*(23*s+8*(t_m+t_p))*m_d4+(30*s2+20*(t_m+t_p)*s+8*t_m*t_p)*m_d2+s*(4*s2+3*(t_m+t_p)*s+2*t_m*t_p))*m_phi2+2*(-32*m_d8+32*(3*s+t_m+t_p)*m_d6-(79*s2+56*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(14*s2+15*(t_m+t_p)*s+16*t_m*t_p)*m_d2+s2*(s+t_m)*(s+t_p)))*np.log(2*m_phi2+m_d2-s-t_max))/(2*np.sqrt(a)*(2*m_phi2-s)*(2*m_phi2+m_d2-s-t_m)**(3/2)*(2*m_phi2+m_d2-s-t_p)**(3/2))-(4*np.log(2*t_max-t_m-t_p+2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)))/np.sqrt(a)-(1/(2*np.sqrt(a)*(2*m_phi2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)))*((4*m_d2-2*(t_m+t_p))*m_phi6+(-20*m_d4+(4*(t_m+t_p)-2*s)*m_d2+12*t_m*t_p+s*(t_m+t_p))*m_phi4+8*(4*m_d2+s)*(m_d4-t_m*t_p)*m_phi2-2*(32*m_d8-32*(t_m+t_p)*m_d6+(-s2+8*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(s*(t_m+t_p)-16*t_m*t_p)*m_d2-s2*t_m*t_p))*np.log((2*t_max-t_m-t_p)*m_d2-t_max*(t_m+t_p)+2*(t_m*t_p+np.sqrt(m_d2-t_m)*np.sqrt(t_max-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_max-t_p)))+((40*m_phi8-2*(10*m_d2+36*s+11*(t_m+t_p))*m_phi6+(-468*m_d4+6*(23*s+6*(t_m+t_p))*m_d2+50*s2+12*t_m*t_p+27*s*(t_m+t_p))*m_phi4-4*(88*m_d6-6*(23*s+8*(t_m+t_p))*m_d4+(30*s2+20*(t_m+t_p)*s+8*t_m*t_p)*m_d2+s*(4*s2+3*(t_m+t_p)*s+2*t_m*t_p))*m_phi2+2*(-32*m_d8+32*(3*s+t_m+t_p)*m_d6-(79*s2+56*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(14*s2+15*(t_m+t_p)*s+16*t_m*t_p)*m_d2+s2*(s+t_m)*(s+t_p)))*np.log((4*t_max-2*(t_m+t_p))*m_phi2-2*s*t_max+s*t_m-t_max*t_m+m_d2*(2*t_max-t_m-t_p)+s*t_p-t_max*t_p+2*t_m*t_p+2*np.sqrt(2*m_phi2+m_d2-s-t_m)*np.sqrt(t_max-t_m)*np.sqrt(2*m_phi2+m_d2-s-t_p)*np.sqrt(t_max-t_p)))/(2*np.sqrt(a)*(2*m_phi2-s)*(2*m_phi2+m_d2-s-t_m)**(3/2)*(2*m_phi2+m_d2-s-t_p)**(3/2)))

    int_tmin = 2*((np.sqrt(a*(t_min-t_m)*(t_min-t_p))*(-8*m_phi6+4*(-3*m_d2+3*s+t_min+t_m+t_p)*m_phi4-2*(3*m_d4-2*(3*s+t_min+t_m+t_p)*m_d2+3*s2+t_min*t_m+t_min*t_p+t_m*t_p+2*s*(t_min+t_m+t_p))*m_phi2-2*m_d6+s3+s2*t_min+s2*t_m+s*t_min*t_m+s2*t_p+s*t_min*t_p+s*t_m*t_p+2*t_min*t_m*t_p+m_d4*(3*s+2*(t_min+t_m+t_p))-m_d2*(3*s2+2*(t_min+t_m+t_p)*s+2*t_m*t_p+2*t_min*(t_m+t_p)))*(m_phi2-4*m_d2)**2)/(a*(t_min-m_d2)*(-2*m_phi2-m_d2+s+t_min)*(t_m-m_d2)*(-2*m_phi2-m_d2+s+t_m)*(t_p-m_d2)*(-2*m_phi2-m_d2+s+t_p))+(1/(2*np.sqrt(a)*(2*m_phi2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)))*((4*m_d2-2*(t_m+t_p))*m_phi6+(-20*m_d4+(4*(t_m+t_p)-2*s)*m_d2+12*t_m*t_p+s*(t_m+t_p))*m_phi4+8*(4*m_d2+s)*(m_d4-t_m*t_p)*m_phi2-2*(32*m_d8-32*(t_m+t_p)*m_d6+(-s2+8*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(s*(t_m+t_p)-16*t_m*t_p)*m_d2-s2*t_m*t_p))*np.log(m_d2-t_min)-((40*m_phi8-2*(10*m_d2+36*s+11*(t_m+t_p))*m_phi6+(-468*m_d4+6*(23*s+6*(t_m+t_p))*m_d2+50*s2+12*t_m*t_p+27*s*(t_m+t_p))*m_phi4-4*(88*m_d6-6*(23*s+8*(t_m+t_p))*m_d4+(30*s2+20*(t_m+t_p)*s+8*t_m*t_p)*m_d2+s*(4*s2+3*(t_m+t_p)*s+2*t_m*t_p))*m_phi2+2*(-32*m_d8+32*(3*s+t_m+t_p)*m_d6-(79*s2+56*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(14*s2+15*(t_m+t_p)*s+16*t_m*t_p)*m_d2+s2*(s+t_m)*(s+t_p)))*np.log(2*m_phi2+m_d2-s-t_min))/(2*np.sqrt(a)*(2*m_phi2-s)*(2*m_phi2+m_d2-s-t_m)**(3/2)*(2*m_phi2+m_d2-s-t_p)**(3/2))-(4*np.log(2*t_min-t_m-t_p+2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)))/np.sqrt(a)-(1/(2*np.sqrt(a)*(2*m_phi2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)))*((4*m_d2-2*(t_m+t_p))*m_phi6+(-20*m_d4+(4*(t_m+t_p)-2*s)*m_d2+12*t_m*t_p+s*(t_m+t_p))*m_phi4+8*(4*m_d2+s)*(m_d4-t_m*t_p)*m_phi2-2*(32*m_d8-32*(t_m+t_p)*m_d6+(-s2+8*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(s*(t_m+t_p)-16*t_m*t_p)*m_d2-s2*t_m*t_p))*np.log((2*t_min-t_m-t_p)*m_d2-t_min*(t_m+t_p)+2*(t_m*t_p+np.sqrt(m_d2-t_m)*np.sqrt(t_min-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_min-t_p)))+((40*m_phi8-2*(10*m_d2+36*s+11*(t_m+t_p))*m_phi6+(-468*m_d4+6*(23*s+6*(t_m+t_p))*m_d2+50*s2+12*t_m*t_p+27*s*(t_m+t_p))*m_phi4-4*(88*m_d6-6*(23*s+8*(t_m+t_p))*m_d4+(30*s2+20*(t_m+t_p)*s+8*t_m*t_p)*m_d2+s*(4*s2+3*(t_m+t_p)*s+2*t_m*t_p))*m_phi2+2*(-32*m_d8+32*(3*s+t_m+t_p)*m_d6-(79*s2+56*(t_m+t_p)*s+32*t_m*t_p)*m_d4+s*(14*s2+15*(t_m+t_p)*s+16*t_m*t_p)*m_d2+s2*(s+t_m)*(s+t_p)))*np.log((4*t_min-2*(t_m+t_p))*m_phi2-2*s*t_min+s*t_m-t_min*t_m+m_d2*(2*t_min-t_m-t_p)+s*t_p-t_min*t_p+2*t_m*t_p+2*np.sqrt(2*m_phi2+m_d2-s-t_m)*np.sqrt(t_min-t_m)*np.sqrt(2*m_phi2+m_d2-s-t_p)*np.sqrt(t_min-t_p)))/(2*np.sqrt(a)*(2*m_phi2-s)*(2*m_phi2+m_d2-s-t_m)**(3/2)*(2*m_phi2+m_d2-s-t_p)**(3/2)))
...
def ker_C_n_pp_dd_s(s, E1, E2, E3, p1, p3, m_d, m_phi, s12_min, s12_max, s34_min, s34_max, vert):
    ...
    t_int[in_res] = ker_C_n_pp_dd_s_t_integral(ct_min[in_res], ct_max[in_res], ct_p[in_res], ct_m[in_res], a[in_res], s[in_res], E1[in_res], E3[in_res], p1[in_res], p3[in_res], m_d, m_phi, vert)
    return t_int
...
def sigma_pp_dd_new(s, m_d, m_phi, vert):
    ...
    # int_t_M2_upper = -2*vert*(-(((6*m_phi4-4*m_phi2*s+s2)*(np.log(m_d2-t_upper)-np.log(2*m_phi2+m_d2-s-t_upper)))/(2*m_phi2-s))+m_phi4*(1/(2*m_phi2+m_d2-s-t_upper)+1/(m_d2-t_upper))-4*m_d2+4*t_upper)

    # int_t_M2_lower = -2*vert*(-(((6*m_phi4-4*m_phi2*s+s2)*(np.log(m_d2-t_lower)-np.log(2*m_phi2+m_d2-s-t_lower)))/(2*m_phi2-s))+m_phi4*(1/(2*m_phi2+m_d2-s-t_lower)+1/(m_d2-t_lower))-4*m_d2+4*t_lower)

    # Anton: For dd --> pp : divide py p1cm*p1cm. For pp --> dd: divide by p3cm*p3cm
    sigma = ((int_t_M2_upper - int_t_M2_lower).real / (64.*np.pi*s*p3cm*p3cm))
...
if __name__ == '__main__':
    ...
    log_E3_min = np.log(m_phi*offset)
    log_E3_max = np.log(max((max_exp_arg + xi_X)*T_d, 1e1*m_phi))
    E3_ = np.exp(np.fmin(log_E3_min * (1.-x) + log_E3_max * x, 6e2))
    # Anton: This is treated as E2 in the article 
    E4_min = np.fmax(2.*m_d - E3_, m_phi*offset)
    log_E4_min = np.log(E4_min)
    ...
    ker_C_n_pp_dd_s_t_integral_val = ker_C_n_pp_dd_s_t_integral(ct_min=ct_min[in_res], ct_max=ct_max[in_res], ct_p=ct_p[in_res], ct_m=ct_m[in_res], a=a[in_res], s=s[in_res], E1=E1, E3=E3, p1=p1, p3=p3, m_d=m_d, m_phi=m_phi, vert=vert_el)

    ker_C_n_pp_dd_s_t_integral_val_new = ker_C_n_pp_dd_s_t_integral_new(ct_min=ct_min[in_res], ct_max=ct_max[in_res], ct_p=ct_p[in_res], ct_m=ct_m[in_res], a=a[in_res], s=s[in_res], E1=E1, E3=E3, p1=p1, p3=p3, m_d=m_d, m_phi=m_phi, vert=vert_el)

    fig = plt.figure()
    ax = fig.add_subplot(121)
    ax2 = fig.add_subplot(122)

    ax.plot(s[in_res], ker_C_n_pp_dd_s_t_integral_val, 'r', label='pp_dd')
    ax2.plot(s[in_res], ker_C_n_pp_dd_s_t_integral_val, 'tab:blue', label='pp_dd_new')
    ...
    vert_pp_dd = y**4 * np.cos(th)**8
    s_sigma = 10**(np.linspace(np.log10(s_min), 3, int(1e4)))
    sigma_pp_dd_val = np.vectorize(sigma_pp_dd)(s=s_sigma, m_d=m_d, m_phi=m_phi, vert=vert_pp_dd)
    sigma_pp_dd_val_new = np.vectorize(sigma_pp_dd_new)(s=s_sigma, m_d=m_d, m_phi=m_phi, vert=vert_pp_dd)

    # ax.plot(s, sigma*s*(s - 4*m_X**2), linestyle='none')        # |M|^2 integrated over t 
    ax.axvline(4*m_phi**2, color='k', linestyle='--')
    ax.plot(s_sigma, sigma_pp_dd_val, color='r', label='sigma scalar')
    ax.plot(s_sigma, sigma_pp_dd_val_new, color='tab:green', label='sigma scalar new')
