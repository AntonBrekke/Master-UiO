...
def ker_C_n_XX_dd_s_t_integral_new(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, vert):
    ...
    # Anton: Write each term of t-integrated matrix element sorted by denominators, evaluated at t_min and t_max. 
    term1_max = -((8*(m_X2-4*m_d2)**2*(2*m_X2-s)*np.sqrt((t_max-t_m)*(t_max-t_p)))/(np.sqrt(a)*(t_max-m_d2)*(m_d2-t_m)*(m_d2-t_p)*(s-2*m_X2))) + (8*(m_X2-4*m_d2)**2*np.sqrt((t_max-t_m)*(t_max-t_p)))/(np.sqrt(a)*(-m_d2-2*m_X2+s+t_max)*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (1/(np.sqrt(a)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)))*4*(8*m_d6*(4*m_X2-7*s)+2*m_d4*(-12*m_X4+8*m_X2*s+s*(s+20*(t_m+t_p)))+m_d2*(4*m_X6+m_X4*(8*(t_m+t_p)-2*s)-8*m_X2*(s*(t_m+t_p)+4*t_m*t_p)-2*s*(s*(t_m+t_p)+12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p)*(np.log(m_d2-t_max)-np.log(m_d2*(2*t_max-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)-t_max*(t_m+t_p)+2*t_m*t_p))

    term2_max = (32*m_d2*s*(4*m_d2+s)*(t_m-m_d2)*(t_p-m_d2)*(np.log(m_d2-t_max)-np.log(m_d2*(2*t_max-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)-t_max*(t_m+t_p)+2*t_m*t_p)))/(np.sqrt(a)*m_X2*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)) - ((32*m_d4*s2*(t_m-m_d2)*(t_p-m_d2)*(np.log(m_d2-t_max)-np.log(m_d2*(2*t_max-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)-t_max*(t_m+t_p)+2*t_m*t_p)))/(np.sqrt(a)*m_X4*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)))

    term3_max = (4*(8*m_d6*(12*m_X2-17*s)+2*m_d4*(108*m_X4-8*m_X2*(13*s+4*(t_m+t_p))+s*(55*s+28*(t_m+t_p)))+2*m_d2*(18*m_X6+m_X4*(23*s-20*(t_m+t_p))-4*m_X2*(15*s2+3*s*(t_m+t_p)-4*t_m*t_p)+3*s*(10*s2+7*s*(t_m+t_p)+4*t_m*t_p))-24*m_X8+2*m_X6*(12*s+7*(t_m+t_p))-m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)+4*m_X2*s2*(2*s+t_m+t_p)-2*s2*(s+t_m)*(s+t_p))*(np.log(m_d2+2*m_X2-s-t_max)-np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_max-t_m-t_p)+m_X2*(4*t_max-2*(t_m+t_p))+t_p*(s-t_max+2*t_m)-2*s*t_max+s*t_m-t_max*t_m)))/(np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))

    term4_max = -((32*m_d2*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p))*(np.log(m_d2+2*m_X2-s-t_max)-np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_max-t_m-t_p)+m_X2*(4*t_max-2*(t_m+t_p))+t_p*(s-t_max+2*t_m)-2*s*t_max+s*t_m-t_max*t_m)))/(np.sqrt(a)*m_X2*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))) + (32*m_d4*s2*(-m_d2+s+t_m)*(-m_d2+s+t_p)*(np.log(m_d2+2*m_X2-s-t_max)-np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_max-t_m-t_p)+m_X2*(4*t_max-2*(t_m+t_p))+t_p*(s-t_max+2*t_m)-2*s*t_max+s*t_m-t_max*t_m)))/(np.sqrt(a)*m_X4*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))

    term5_max = -((16*np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)+2*t_max-t_m-t_p))/np.sqrt(a)) - ((128*m_d2*np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)+2*t_max-t_m-t_p))/(np.sqrt(a)*m_X2)) + (32*m_d2*s*np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)+2*t_max-t_m-t_p))/(np.sqrt(a)*m_X4)

    term1_min = -((8*(m_X2-4*m_d2)**2*(2*m_X2-s)*np.sqrt((t_min-t_m)*(t_min-t_p)))/(np.sqrt(a)*(t_min-m_d2)*(m_d2-t_m)*(m_d2-t_p)*(s-2*m_X2))) + (8*(m_X2-4*m_d2)**2*np.sqrt((t_min-t_m)*(t_min-t_p)))/(np.sqrt(a)*(-m_d2-2*m_X2+s+t_min)*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (1/(np.sqrt(a)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)))*4*(8*m_d6*(4*m_X2-7*s)+2*m_d4*(-12*m_X4+8*m_X2*s+s*(s+20*(t_m+t_p)))+m_d2*(4*m_X6+m_X4*(8*(t_m+t_p)-2*s)-8*m_X2*(s*(t_m+t_p)+4*t_m*t_p)-2*s*(s*(t_m+t_p)+12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p)*(np.log(m_d2-t_min)-np.log(m_d2*(2*t_min-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)-t_min*(t_m+t_p)+2*t_m*t_p))

    term2_min = (32*m_d2*s*(4*m_d2+s)*(t_m-m_d2)*(t_p-m_d2)*(np.log(m_d2-t_min)-np.log(m_d2*(2*t_min-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)-t_min*(t_m+t_p)+2*t_m*t_p)))/(np.sqrt(a)*m_X2*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)) - ((32*m_d4*s2*(t_m-m_d2)*(t_p-m_d2)*(np.log(m_d2-t_min)-np.log(m_d2*(2*t_min-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)-t_min*(t_m+t_p)+2*t_m*t_p)))/(np.sqrt(a)*m_X4*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)))

    term3_min = (4*(8*m_d6*(12*m_X2-17*s)+2*m_d4*(108*m_X4-8*m_X2*(13*s+4*(t_m+t_p))+s*(55*s+28*(t_m+t_p)))+2*m_d2*(18*m_X6+m_X4*(23*s-20*(t_m+t_p))-4*m_X2*(15*s2+3*s*(t_m+t_p)-4*t_m*t_p)+3*s*(10*s2+7*s*(t_m+t_p)+4*t_m*t_p))-24*m_X8+2*m_X6*(12*s+7*(t_m+t_p))-m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)+4*m_X2*s2*(2*s+t_m+t_p)-2*s2*(s+t_m)*(s+t_p))*(np.log(m_d2+2*m_X2-s-t_min)-np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_min-t_m-t_p)+m_X2*(4*t_min-2*(t_m+t_p))+t_p*(s-t_min+2*t_m)-2*s*t_min+s*t_m-t_min*t_m)))/(np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))

    term4_min = -((32*m_d2*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p))*(np.log(m_d2+2*m_X2-s-t_min)-np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_min-t_m-t_p)+m_X2*(4*t_min-2*(t_m+t_p))+t_p*(s-t_min+2*t_m)-2*s*t_min+s*t_m-t_min*t_m)))/(np.sqrt(a)*m_X2*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))) + (32*m_d4*s2*(-m_d2+s+t_m)*(-m_d2+s+t_p)*(np.log(m_d2+2*m_X2-s-t_min)-np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t_min-t_m-t_p)+m_X2*(4*t_min-2*(t_m+t_p))+t_p*(s-t_min+2*t_m)-2*s*t_min+s*t_m-t_min*t_m)))/(np.sqrt(a)*m_X4*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))

    term5_min = -((16*np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)+2*t_min-t_m-t_p))/np.sqrt(a)) - ((128*m_d2*np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)+2*t_min-t_m-t_p))/(np.sqrt(a)*m_X2)) + (32*m_d2*s*np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)+2*t_min-t_m-t_p))/(np.sqrt(a)*m_X4)
...
def ker_C_34_12_s_t_integral(s, t, a, ct_m, ct_p, E1, E3, p1, p3, m1, m2, m3, m4, vert, m_X2, m_Gamma_X2, gV1=0, gV2=0, res_sub=False):
    ...
    integrand = vector_mediator.M2_gen(s, t, m1, m2, m3, m4, vert, m_X2, m_Gamma_X2, gV1, gV2, res_sub) * 1/np.sqrt(a*(t - t_m)*(t - t_p))
    return integrand
...
def sigma_XX_dd_new(s, m_d, m_X, vert):
    ...
    # Anton: t-integrated squared matrix elements
    # Anton: imaginary parts from upper - lower will cancel
    int_t_M2_upper = -((8*vert*((m_X4*(m_X2-4*m_d2)**2)/(m_d2+2*m_X2-s-t_upper)+2*t_upper*(m_d2*(8*m_X2-2*s)+m_X4)+(m_X4*(m_X2-4*m_d2)**2)/(m_d2-t_upper)-((4*m_d4*s*(4*m_X2-s)+4*m_d2*m_X2*(-4*m_X4-3*m_X2*s+s2)+m_X4*(4*m_X4+s2))*(np.log(t_upper-m_d2)-np.log(-m_d2-2*m_X2+s+t_upper)))/(2*m_X2-s)))/m_X4)

    int_t_M2_lower = -((8*vert*((m_X4*(m_X2-4*m_d2)**2)/(m_d2+2*m_X2-s-t_lower)+2*t_lower*(m_d2*(8*m_X2-2*s)+m_X4)+(m_X4*(m_X2-4*m_d2)**2)/(m_d2-t_lower)-((4*m_d4*s*(4*m_X2-s)+4*m_d2*m_X2*(-4*m_X4-3*m_X2*s+s2)+m_X4*(4*m_X4+s2))*(np.log(t_lower-m_d2)-np.log(-m_d2-2*m_X2+s+t_lower)))/(2*m_X2-s)))/m_X4)
...
if __name__ == '__main__':
    ...
    m_d = 3.5e-6          # 1e-6*M GeV = M keV, 2e-5 GeV = 20 keV
    m_a = 0.
    ...
    ker_C_n_XX_dd_s_t_integral_val = ker_C_n_XX_dd_s_t_integral(ct_min=ct_min[in_res], ct_max=ct_max[in_res], ct_p=ct_p[in_res], ct_m=ct_m[in_res], a=a[in_res], s=s[in_res], E1=E1, E3=E3, p1=p1, p3=p3, m_d=m_d, m_X=m_X, vert=vert_el)

    ker_C_n_XX_dd_s_t_integral_val_new = ker_C_n_XX_dd_s_t_integral_new_2(ct_min=ct_min[in_res], ct_max=ct_max[in_res], ct_p=ct_p[in_res], ct_m=ct_m[in_res], a=a[in_res], s=s[in_res], E1=E1, E3=E3, p1=p1, p3=p3, m_d=m_d, m_X=m_X, vert=vert_el)
    ...
    # ker_C_n_pp_dd_s_t_integral_val_previous = ker_C_n_pp_dd_s_t_integral_previous(ct_min=ct_min[in_res], ct_max=ct_max[in_res], ct_p=ct_p[in_res], ct_m=ct_m[in_res], a=a[in_res], s=s[in_res], E1=E1, E3=E3, p1=p1, p3=p3, m_d=m_d, m_phi=m_X, vert=vert_el)
    ...
    ax.plot(s_sigma, sigma_XX_dd_val_new, color='tab:green', label='sigma vector new')
