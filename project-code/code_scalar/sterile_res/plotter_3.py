...
plt.contour(np.log10(1e6*md), np.log10(sin22th), np.log10(y), levels=10, colors='forestgreen', linewidths = 0.4, zorder=-1, linestyles='-')
...
plt.tight_layout()
# plt.savefig('plot_md_sin22th_rm_3_0.pdf')
plt.show()
