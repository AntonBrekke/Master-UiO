...
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_new_2(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, vert):
    """
    ...
    s4 = s4.astype(np.complex128)
    a = a.astype(np.complex128)
    
    # Anton: Write each term of t-integrated matrix element sorted by denominators, evaluated at t_min and t_max. 
    int_tmax = -(1/(m_X4))*8*(-(np.divide(((m_X2-4*m_d2)**2*np.sqrt(a*(t_max-t_m)*(t_max-t_p))*(-2*m_d6+(-6*m_X2+3*s+2*(t_max+t_m+t_p))*m_d4-(12*m_X4-4*(3*s+t_max+t_m+t_p)*m_X2+3*s2+2*t_m*t_p+2*t_max*(t_m+t_p)+2*s*(t_max+t_m+t_p))*m_d2-8*m_X6+s3+s2*t_max+s2*t_m+s*t_max*t_m+s2*t_p+s*t_max*t_p+s*t_m*t_p+2*t_max*t_m*t_p+4*m_X4*(3*s+t_max+t_m+t_p)-2*m_X2*(3*s2+2*(t_max+t_m+t_p)*s+t_m*t_p+t_max*(t_m+t_p)))*m_X4),(a*(t_max-m_d2)*(-m_d2-2*m_X2+s+t_max)*(t_m-m_d2)*(-m_d2-2*m_X2+s+t_m)*(t_p-m_d2)*(-m_d2-2*m_X2+s+t_p))))-(np.divide(1,(2*np.sqrt(a)*(2*m_X2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2))))*(8*(4*m_X2-s)*s*m_d8+8*(4*m_X6-7*s*m_X4+s*(s-4*(t_m+t_p))*m_X2+s2*(t_m+t_p))*m_d6+(-24*m_X8+16*s*m_X6+2*s*(s+20*(t_m+t_p))*m_X4-8*s*(s*(t_m+t_p)-4*t_m*t_p)*m_X2-8*s2*t_m*t_p)*m_d4+(4*m_X10+(8*(t_m+t_p)-2*s)*m_X8-8*(4*t_m*t_p+s*(t_m+t_p))*m_X6-2*s*(12*t_m*t_p+s*(t_m+t_p))*m_X4+8*s2*t_m*t_p*m_X2)*m_d2+m_X4*(-2*(t_m+t_p)*m_X6+(8*t_m*t_p+s*(t_m+t_p))*m_X4+2*s2*t_m*t_p))*np.log(m_d2-t_max)+np.divide(((8*(4*m_X2-s)*s*m_d8-8*(12*m_X6-17*s*m_X4+s*(11*s+4*(t_m+t_p))*m_X2-s2*(2*s+t_m+t_p))*m_d6-2*(108*m_X8-8*(13*s+4*(t_m+t_p))*m_X6+s*(55*s+28*(t_m+t_p))*m_X4-4*s*(6*s2+5*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d4+2*m_X2*(-18*m_X8+(20*(t_m+t_p)-23*s)*m_X6+4*(15*s2+3*(t_m+t_p)*s-4*t_m*t_p)*m_X4-3*s*(10*s2+7*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d2+m_X4*(24*m_X8-2*(12*s+7*(t_m+t_p))*m_X6+(14*s2+7*(t_m+t_p)*s+8*t_m*t_p)*m_X4-4*s2*(2*s+t_m+t_p)*m_X2+2*s2*(s+t_m)*(s+t_p)))*np.log(m_d2+2*m_X2-s-t_max)),(2*np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2)))+(2*(m_X4+m_d2*(8*m_X2-2*s))*np.log(2*t_max-t_m-t_p+2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)))/np.sqrt(a)+(np.divide(1,(2*np.sqrt(a)*(2*m_X2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2))))*(8*(4*m_X2-s)*s*m_d8+8*(4*m_X6-7*s*m_X4+s*(s-4*(t_m+t_p))*m_X2+s2*(t_m+t_p))*m_d6+(-24*m_X8+16*s*m_X6+2*s*(s+20*(t_m+t_p))*m_X4-8*s*(s*(t_m+t_p)-4*t_m*t_p)*m_X2-8*s2*t_m*t_p)*m_d4+(4*m_X10+(8*(t_m+t_p)-2*s)*m_X8-8*(4*t_m*t_p+s*(t_m+t_p))*m_X6-2*s*(12*t_m*t_p+s*(t_m+t_p))*m_X4+8*s2*t_m*t_p*m_X2)*m_d2+m_X4*(-2*(t_m+t_p)*m_X6+(8*t_m*t_p+s*(t_m+t_p))*m_X4+2*s2*t_m*t_p))*np.log((2*t_max-t_m-t_p)*m_d2-t_max*(t_m+t_p)+2*(t_m*t_p+np.sqrt(m_d2-t_m)*np.sqrt(t_max-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_max-t_p)))-np.divide(((8*(4*m_X2-s)*s*m_d8-8*(12*m_X6-17*s*m_X4+s*(11*s+4*(t_m+t_p))*m_X2-s2*(2*s+t_m+t_p))*m_d6-2*(108*m_X8-8*(13*s+4*(t_m+t_p))*m_X6+s*(55*s+28*(t_m+t_p))*m_X4-4*s*(6*s2+5*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d4+2*m_X2*(-18*m_X8+(20*(t_m+t_p)-23*s)*m_X6+4*(15*s2+3*(t_m+t_p)*s-4*t_m*t_p)*m_X4-3*s*(10*s2+7*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d2+m_X4*(24*m_X8-2*(12*s+7*(t_m+t_p))*m_X6+(14*s2+7*(t_m+t_p)*s+8*t_m*t_p)*m_X4-4*s2*(2*s+t_m+t_p)*m_X2+2*s2*(s+t_m)*(s+t_p)))*np.log((2*t_max-t_m-t_p)*m_d2-2*s*t_max+s*t_m-t_max*t_m+s*t_p-t_max*t_p+2*t_m*t_p+m_X2*(4*t_max-2*(t_m+t_p))+2*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(t_max-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)*np.sqrt(t_max-t_p))),(2*np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))))
    
    int_tmin = -(1/(m_X4))*8*(-(np.divide(((m_X2-4*m_d2)**2*np.sqrt(a*(t_min-t_m)*(t_min-t_p))*(-2*m_d6+(-6*m_X2+3*s+2*(t_min+t_m+t_p))*m_d4-(12*m_X4-4*(3*s+t_min+t_m+t_p)*m_X2+3*s2+2*t_m*t_p+2*t_min*(t_m+t_p)+2*s*(t_min+t_m+t_p))*m_d2-8*m_X6+s3+s2*t_min+s2*t_m+s*t_min*t_m+s2*t_p+s*t_min*t_p+s*t_m*t_p+2*t_min*t_m*t_p+4*m_X4*(3*s+t_min+t_m+t_p)-2*m_X2*(3*s2+2*(t_min+t_m+t_p)*s+t_m*t_p+t_min*(t_m+t_p)))*m_X4),(a*(t_min-m_d2)*(-m_d2-2*m_X2+s+t_min)*(t_m-m_d2)*(-m_d2-2*m_X2+s+t_m)*(t_p-m_d2)*(-m_d2-2*m_X2+s+t_p))))-(np.divide(1,(2*np.sqrt(a)*(2*m_X2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2))))*(8*(4*m_X2-s)*s*m_d8+8*(4*m_X6-7*s*m_X4+s*(s-4*(t_m+t_p))*m_X2+s2*(t_m+t_p))*m_d6+(-24*m_X8+16*s*m_X6+2*s*(s+20*(t_m+t_p))*m_X4-8*s*(s*(t_m+t_p)-4*t_m*t_p)*m_X2-8*s2*t_m*t_p)*m_d4+(4*m_X10+(8*(t_m+t_p)-2*s)*m_X8-8*(4*t_m*t_p+s*(t_m+t_p))*m_X6-2*s*(12*t_m*t_p+s*(t_m+t_p))*m_X4+8*s2*t_m*t_p*m_X2)*m_d2+m_X4*(-2*(t_m+t_p)*m_X6+(8*t_m*t_p+s*(t_m+t_p))*m_X4+2*s2*t_m*t_p))*np.log(m_d2-t_min)+np.divide(((8*(4*m_X2-s)*s*m_d8-8*(12*m_X6-17*s*m_X4+s*(11*s+4*(t_m+t_p))*m_X2-s2*(2*s+t_m+t_p))*m_d6-2*(108*m_X8-8*(13*s+4*(t_m+t_p))*m_X6+s*(55*s+28*(t_m+t_p))*m_X4-4*s*(6*s2+5*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d4+2*m_X2*(-18*m_X8+(20*(t_m+t_p)-23*s)*m_X6+4*(15*s2+3*(t_m+t_p)*s-4*t_m*t_p)*m_X4-3*s*(10*s2+7*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d2+m_X4*(24*m_X8-2*(12*s+7*(t_m+t_p))*m_X6+(14*s2+7*(t_m+t_p)*s+8*t_m*t_p)*m_X4-4*s2*(2*s+t_m+t_p)*m_X2+2*s2*(s+t_m)*(s+t_p)))*np.log(m_d2+2*m_X2-s-t_min)),(2*np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2)))+(2*(m_X4+m_d2*(8*m_X2-2*s))*np.log(2*t_min-t_m-t_p+2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)))/np.sqrt(a)+(np.divide(1,(2*np.sqrt(a)*(2*m_X2-s)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2))))*(8*(4*m_X2-s)*s*m_d8+8*(4*m_X6-7*s*m_X4+s*(s-4*(t_m+t_p))*m_X2+s2*(t_m+t_p))*m_d6+(-24*m_X8+16*s*m_X6+2*s*(s+20*(t_m+t_p))*m_X4-8*s*(s*(t_m+t_p)-4*t_m*t_p)*m_X2-8*s2*t_m*t_p)*m_d4+(4*m_X10+(8*(t_m+t_p)-2*s)*m_X8-8*(4*t_m*t_p+s*(t_m+t_p))*m_X6-2*s*(12*t_m*t_p+s*(t_m+t_p))*m_X4+8*s2*t_m*t_p*m_X2)*m_d2+m_X4*(-2*(t_m+t_p)*m_X6+(8*t_m*t_p+s*(t_m+t_p))*m_X4+2*s2*t_m*t_p))*np.log((2*t_min-t_m-t_p)*m_d2-t_min*(t_m+t_p)+2*(t_m*t_p+np.sqrt(m_d2-t_m)*np.sqrt(t_min-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t_min-t_p)))-np.divide(((8*(4*m_X2-s)*s*m_d8-8*(12*m_X6-17*s*m_X4+s*(11*s+4*(t_m+t_p))*m_X2-s2*(2*s+t_m+t_p))*m_d6-2*(108*m_X8-8*(13*s+4*(t_m+t_p))*m_X6+s*(55*s+28*(t_m+t_p))*m_X4-4*s*(6*s2+5*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d4+2*m_X2*(-18*m_X8+(20*(t_m+t_p)-23*s)*m_X6+4*(15*s2+3*(t_m+t_p)*s-4*t_m*t_p)*m_X4-3*s*(10*s2+7*(t_m+t_p)*s+4*t_m*t_p)*m_X2+4*s2*(s+t_m)*(s+t_p))*m_d2+m_X4*(24*m_X8-2*(12*s+7*(t_m+t_p))*m_X6+(14*s2+7*(t_m+t_p)*s+8*t_m*t_p)*m_X4-4*s2*(2*s+t_m+t_p)*m_X2+2*s2*(s+t_m)*(s+t_p)))*np.log((2*t_min-t_m-t_p)*m_d2-2*s*t_min+s*t_m-t_min*t_m+s*t_p-t_min*t_p+2*t_m*t_p+m_X2*(4*t_min-2*(t_m+t_p))+2*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(t_min-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)*np.sqrt(t_min-t_p))),(2*np.sqrt(a)*(2*m_X2-s)*(m_d2+2*m_X2-s-t_m)**(3/2)*(m_d2+2*m_X2-s-t_p)**(3/2))))
    

    # int_tmax = term1_max + term2_max + term3_max + term4_max + term5_max
    # int_tmin = term1_min + term2_min + term3_min + term4_min + term5_min
...
# For XX --> dd (for some reason, instead of dd --> XX)
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_new(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, vert):
    """
    Solved for matrix-element and integrated over variable t in collision
    operator using Mathematica, int_Rt |M|^2/sqrt((t-tm)*(t-tp)). 
    These expressions can be found in nu_s_nu_s_to_XX.nb
    ...
    # prefac_2: purely imaginary --> "make real", prefac_2 = -i*prefac_2' after accounting for imaginary 
    # contributions (from sqrt(a)=i*sqrt(-a), a<0 ). Then only count imaginary contributions in terms multiplied by prefac_2
    # prefac_2 defined below is then really prefac_2'
    prefac_2 = (1/(m_X4*np.sqrt(-a)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s))) * (4*m_X4*(8*m_d6*(4*m_X2-7*s)+2*m_d4*(-12*m_X4+8*m_X2*s+s*(s+20*(t_m+t_p)))+m_d2*(4*m_X6+m_X4*(8*(t_m+t_p)-2*s)-8*m_X2*(s *(t_m+t_p)+4*t_m*t_p)-2*s*(s*(t_m+t_p)+12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p) + 32*m_X2*m_d2*s*(4*m_d2+s)*(m_d2-t_m)*(m_d2-t_p) - 32*m_d4*s2*(m_d2-t_m)*(m_d2-t_p))

    # term2_max: purely imaginary due to prefac_2. -i*prefac_2' * (-ln(t_m-t_p)) --> discard 
    # term2_min: -i*prefac_2'*(-i*pi - ln(t_m-t_p)) = -prefac_2' * pi "cancel i's"
    term2_max = np.zeros(n)
    term2_min = -prefac_2 * np.pi

    # prefac_3: purely imaginary --> "make real", prefac_3 = -i*prefac_3' after accounting for imaginary 
    # contributions (from sqrt(a)=i*sqrt(-a), a<0 ). Then only count imaginary contributions in terms multiplied by prefac_3.
    # prefac_3 defined below is then really prefac_3'
    prefac_3 = (-1/(m_X4*np.sqrt(-a)*(2*m_X2-s)*(s+t_m-m_d2-2*m_X2)**(3/2)*(s+t_p-m_d2-2*m_X2)**(3/2))) * (4*m_X4*(8*m_d6*(12*m_X2-17*s)+2*m_d4*(108*m_X4-8*m_X2*(13*s+4*(t_m+t_p))+s*(55*s+28*(t_m+t_p)))+2*m_d2*(18*m_X6+m_X4*(23*s-20*(t_m+t_p))-4*m_X2*(15*s2+3*s*(t_m+t_p)-4*t_m*t_p)+3*s*(10*s2+7*s*(t_m+t_p)+4*t_m*t_p))-24*m_X8+2*m_X6*(12*s+7*(t_m+t_p))-m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)+4*m_X2*s2*(2*s+t_m+t_p)-2*s2*(s+t_m)*(s+t_p)) - 32*m_X2*(m_d2)*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p)) + 32*m_d4*s2*(m_d2-s-t_m)*(m_d2-s-t_p))

    # term3_max: purely imaginary due to prefac_3. -i*prefac_3' * (-ln(t_m-t_p)) --> discard 
    # term3_min: -i*prefac_3'*(i*pi - ln(t_m-t_p)) = prefac_3' * pi "cancel i's"
    term3_max = np.zeros(n)
    term3_min = prefac_3 * np.pi

    # prefac_4: purely imaginary --> "make real", prefac_4 = -i*prefac_4' after accounting for imaginary 
    # contributions (from sqrt(a)=i*sqrt(-a), a<0 ). Then only count imaginary contributions in terms multiplied by prefac_4.
    # prefac_4 defined below is then really prefac_4'
    prefac_4 = (1/(m_X4*np.sqrt(-a))) * (16*m_X4 + 128*m_d2*m_X2 - 32*m_d2*s)
    
    # term4_max: -i*prefac_4' * (i*pi + ln(t_m-t_p)) = prefac_4' * pi, discard imaginary contribution
    # term4_min: -i*prefac_4' * ln(t_m-t_p) purely imaginary --> discard 
    # term4_max = prefac_4 * np.pi
    # term4_min = np.zeros(n)

    # term4_max = prefac_4 * np.log(t_p-t_m)
    # term4_min = prefac_4 * np.log(t_m-t_p)
    # term4_max - term4_min = prefac_4 * i*pi = prefac_4' * pi = log_part

    log_part = prefac_4 * np.pi
    ...
    if np.any(in_max_neq):
        ...
        term2_max[in_max_neq] = prefac_2[in_max_neq] * (np.log(m_d2-t_max_xn)-np.log(m_d2*(2*t_max_xn-t_m_xn-t_p_xn)+2*np.sqrt(m_d2-t_m_xn)*np.sqrt(m_d2-t_p_xn)*np.sqrt(t_max_xn-t_m_xn+0j)*np.sqrt(t_max_xn-t_p_xn)-t_max_xn*(t_m_xn+t_p_xn)+2*t_m_xn*t_p_xn)*(1j)).real

        term3_max[in_max_neq] = prefac_3[in_max_neq] * (np.log(m_d2+2*m_X2-s_xn-t_max_xn+0j)-np.log(-2*np.sqrt(t_max_xn-t_m_xn+0j)*np.sqrt(t_max_xn-t_p_xn)*np.sqrt(s_xn+t_m_xn-m_d2-2*m_X2)*np.sqrt(s_xn+t_p_xn-m_d2-2*m_X2)+m_d2*(2*t_max_xn-t_m_xn-t_p_xn)+m_X2*(4*t_max_xn-2*(t_m_xn+t_p_xn))+t_p_xn*(s_xn-t_max_xn+2*t_m_xn)-2*s_xn*t_max_xn+s_xn*t_m_xn-t_max_xn*t_m_xn)*(1j)).real
    ...
    if np.any(in_min_neq):
        ...
        term2_min[in_min_neq] = prefac_2[in_min_neq] * (np.log(m_d2-t_min_mn)-np.log(m_d2*(2*t_min_mn-t_m_mn-t_p_mn)+2*np.sqrt(m_d2-t_m_mn)*np.sqrt(m_d2-t_p_mn)*np.sqrt(t_min_mn-t_m_mn+0j)*np.sqrt(t_min_mn-t_p_mn)-t_min_mn*(t_m_mn+t_p_mn)+2*t_m_mn*t_p_mn)*(1j)).real

        term3_min[in_min_neq] = prefac_3[in_min_neq] * (np.log(m_d2+2*m_X2-s_mn-t_min_mn+0j)-np.log(-2*np.sqrt(t_min_mn-t_m_mn+0j)*np.sqrt(t_min_mn-t_p_mn)*np.sqrt(s_mn+t_m_mn-m_d2-2*m_X2)*np.sqrt(s_mn+t_p_mn-m_d2-2*m_X2)+m_d2*(2*t_min_mn-t_m_mn-t_p_mn)+m_X2*(4*t_min_mn-2*(t_m_mn+t_p_mn))+t_p_mn*(s_mn-t_min_mn+2*t_m_mn)-2*s_mn*t_min_mn+s_mn*t_m_mn-t_min_mn*t_m_mn)*(1j)).real

    if np.any(in_any_neq):
        log_part[in_any_neq] = prefac_4[in_any_neq] * (np.log(2*np.sqrt(t_max[in_any_neq]-t_m[in_any_neq]+0j)*np.sqrt(t_max[in_any_neq]-t_p[in_any_neq])-2*t_max[in_any_neq]+t_m[in_any_neq]+t_p[in_any_neq]) - np.log(2*np.sqrt(t_min[in_any_neq]-t_m[in_any_neq]+0j)*np.sqrt(t_min[in_any_neq]-t_p[in_any_neq])-2*t_min[in_any_neq]+t_m[in_any_neq]+t_p[in_any_neq])*(1j)).real

    # Full expressions 
    # term1_max = -((8*(m_X2-4*m_d2)**2*np.sqrt(a*(t-t_m)*(t-t_p)))/(a*(m_d2-t)*(m_d2-t_m)*(m_d2-t_p))) - ((8*(m_X2-4*m_d2)**2*np.sqrt(a*(t-t_m)*(t-t_p)))/(a*(m_d2+2*m_X2-s-t)*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)))
    
    # term2_max = prefac_2 * (np.log(m_d2-t)-np.log(m_d2*(2*t-t_m-t_p)+2*np.sqrt(m_d2-t_m)*np.sqrt(m_d2-t_p)*np.sqrt(t-t_m)*np.sqrt(t-t_p)-t*(t_m+t_p)+2*t_m*t_p))
    
    # term3_max = prefac_3 * (np.log(m_d2+2*m_X2-s-t)-np.log(2*np.sqrt(t-t_m)*np.sqrt(t-t_p)*np.sqrt(m_d2+2*m_X2-s-t_m)*np.sqrt(m_d2+2*m_X2-s-t_p)+m_d2*(2*t-t_m-t_p)+m_X2*(4*t-2*(t_m+t_p))+t_p*(s-t+2*t_m)-2*s*t+s*t_m-t*t_m))
    
    # term4_max = prefac_4 * np.log(2*np.sqrt(t-t_m)*np.sqrt(t-t_p)-2*t+t_m+t_p)

    # log_part = prefac_4 * (np.log(2*np.sqrt(t_max-t_m)*np.sqrt(t_max-t_p)-2*t_max+t_m+t_p) - np.log(2*np.sqrt(t_min-t_m)*np.sqrt(t_min-t_p)-2*t_min+t_m+t_p))
...
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_new_3(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, m_h, vert, th, m_Gamma_h2):
    """
    Solved for matrix-element and integrated over variable t in collision
    operator using Mathematica, int_Rt |M|^2/sqrt((t-tm)*(t-tp)). 
    These expressions can be found in nu_s_nu_s_to_XX.nb
    ...
    prefac_2 = (1/(SQA*(2*m_X2-s)*np.sqrt(a*(t_m-m_d2)*(m_d2-t_p))**(3/2)))*8*(48*m_d8+16*m_d6*(4*m_X2-3*(s+t_m+t_p))+2*m_d4*(-20*m_X4+4*m_X2*(3*s+t_m+t_p)+s2+6*s*(t_m+t_p)+24*t_m*t_p)+2*m_d2*(2*m_X6+m_X4*(8*(t_m+t_p)-s)-2*m_X2*(3*s*(t_m+t_p)+20*t_m*t_p)-s*(s*(t_m+t_p)-12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p)

    term2_max = np.zeros(n)
    term2_min = prefac_2 * np.pi/2

    prefac_3 = -1/(SQA*(2*m_X2-s)*np.sqrt(a*(s+t_m-m_d2-2*m_X2)*(m_d2+2*m_X2-s-t_p))**(3/2))*8*(48*m_d8-16*m_d6*(2*m_X2+3*(t_m+t_p))-2*m_d4*(180*m_X4-4*m_X2*(41*s+7*(t_m+t_p))+35*s2+6*s*(t_m+t_p)-24*t_m*t_p)-2*m_d2*(98*m_X6-m_X4*(153*s+64*(t_m+t_p))+m_X2*(72*s2+58*s*(t_m+t_p)+40*t_m*t_p)-s*(10*s2+11*s*(t_m+t_p)+12*t_m*t_p))+24*m_X8-2*m_X6*(12*s+7*(t_m+t_p))+m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)-4*m_X2*s2*(2*s+t_m+t_p)+2*s2*(s+t_m)*(s+t_p))

    term3_max = np.zeros(n)
    term3_min = prefac_3 * np.pi/2

    # term4_max = -((16 g^4 log(tm-tp))/(Sqrt[a] SQA))
    # term4_min = -((16 g^4 log(tm-tp))/(Sqrt[a] SQA))
    # log_part = term4_max - term4_min = 16*vert/(np.sqrt(-a)*SQA) * np.pi

    log_part = 16/(np.sqrt(-a)*SQA) * np.pi
    ...
    if np.any(in_max_neq):
        ...
        term1_max[in_max_neq] = -((8*(m_X2-6*m_d2)**2*np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn)))/(a_xn*(m_d2-t_max_xn)*(m_d2-t_m_xn)*(m_d2-t_p_xn)))-((8*(m_X2-6*m_d2)**2*np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn)))/(a_xn*(m_d2+2*m_X2-s_xn-t_max_xn)*(m_d2+2*m_X2-s_xn-t_m_xn)*(m_d2+2*m_X2-s_xn-t_p_xn)))

        term2_max[in_max_neq] = prefac_2[in_max_neq] * np.arctan(np.sqrt(((m_d2-t_p_xn)*(t_m_xn-t_max_xn))/((m_d2-t_m_xn)*(t_max_xn-t_p_xn))))

        term3_max[in_max_neq] = prefac_3[in_max_neq] * np.arctan(-np.sqrt((t_max_xn-t_m_xn)*(m_d2+2*m_X2-s_xn-t_p_xn))/np.sqrt((t_max_xn-t_p_xn)*(s_xn+t_m_xn-m_d2-2*m_X2)))
    ...
    if np.any(in_min_neq):
        ...
        term1_min[in_min_neq] = -((8*(m_X2-6*m_d2)**2*np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn)))/(a_mn*(m_d2-t_min_mn)*(m_d2-t_m_mn)*(m_d2-t_p_mn)))-((8*(m_X2-6*m_d2)**2*np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn)))/(a_mn*(m_d2+2*m_X2-s_mn-t_min_mn)*(m_d2+2*m_X2-s_mn-t_m_mn)*(m_d2+2*m_X2-s_mn-t_p_mn)))

        term2_min[in_min_neq] = prefac_2[in_min_neq] * np.arctan(np.sqrt(((m_d2-t_p_mn)*(t_m_mn-t_min_mn))/((m_d2-t_m_mn)*(t_min_mn-t_p_mn))))

        term3_min[in_min_neq] = prefac_3[in_min_neq] * np.arctan(-np.sqrt((t_min_mn-t_m_mn)*(m_d2+2*m_X2-s_mn-t_p_mn))/np.sqrt((t_min_mn-t_p_mn)*(s_mn+t_m_mn-m_d2-2*m_X2)))

    if np.any(in_any_neq):
        log_part[in_any_neq] = (-((32*np.log(np.sqrt(t_max[in_any_neq]-t_m[in_any_neq]+0j)+np.sqrt(t_max[in_any_neq]-t_p[in_any_neq])))/(np.sqrt(a[in_any_neq]+0j)*SQA))+((32*np.log(np.sqrt(t_min[in_any_neq]-t_m[in_any_neq]+0j)+np.sqrt(t_min[in_any_neq]-t_p[in_any_neq])))/(np.sqrt(a[in_any_neq]+0j)*SQA))).real
...
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_Higgs(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, m_h, vert, th, m_Gamma_h2):
    """
    Solved for matrix-element and integrated over variable t in collision
    operator using Mathematica, int_Rt |M|^2/sqrt((t-tm)*(t-tp)). 
    These expressions can be found in nu_s_nu_s_to_XX.nb
    ...
    prefac_2 = (-1/(SQA*(2*m_X2-s)*(-a*(m_d2-t_m)*(m_d2-t_p))**(3/2)))*4*a*(8*m_d6*(4*m_X2-7*s)+2*m_d4*(-12*m_X4+8*m_X2*s+s*(s+20*(t_m+t_p)))+m_d2*(4*m_X6+m_X4*(8*(t_m+t_p)-2*s)-8*m_X2*(s*(t_m+t_p)+4*t_m*t_p)-2*s*(s*(t_m+t_p)+12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p) + (128*m_d2*(m_h2-s)*(8*m_d2*(s-m_X2)+2*m_X4-m_X2*s))/(gss*SQA*(s-2*m_X2)*((m_h2-s)**2+m_Gamma_h2)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))) + (32*m_d2*s*(4*m_d2+s))/(m_X2*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))) + (384*m_d4*s2*(m_h2-s))/(gss*m_X2*SQA*(2*m_X2-s)*((m_h2-s)**2+m_Gamma_h2)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))) + (64*m_d4*s3*(s-m_h2))/(gss*m_X4*SQA*(2*m_X2-s)*((m_h2-s)**2+m_Gamma_h2)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p)))

    # term2_max = prefac_2' * (-np.log(t_m-t_p))
    # term2_min = prefac_2' * (-np.log(t_p-t_m))

    # term2_max - term2_min = i*pi, 
    # prefac2'*(term2_max - term2_min) = prefac2 * pi
    term2_max_min_diff = prefac_2 * (np.pi)

    # prefac3 = 1/(i) * prefac3'
    prefac_3 = (-128*m_d2*(s-m_h2)*(8*m_d6*(s-m_X2)+m_d4*(-30*m_X4+m_X2*(47*s+8*(t_m+t_p))-4*s*(7*s+2*(t_m+t_p)))+m_d2*(-24*m_X6+14*m_X4*(4*s+t_m+t_p)-m_X2*(50*s2+23*s*(t_m+t_p)+8*t_m*t_p)+2*s*(11*s2+7*s*(t_m+t_p)+4*t_m*t_p))+m_X2*(2*m_X2-s)*(2*m_X2-s-t_m)*(2*m_X2-s-t_p)))/(np.sqrt(-a)*gss*SQA*(s-2*m_X2)*((m_h2-s)**2+m_Gamma_h2)*(t_m+s-m_d2-2*m_X2)**(3/2)*(t_p+s-m_d2-2*m_X2)**(3/2)) + ((32*m_d2*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p)))/(np.sqrt(-a)*m_X2*SQA*(2*m_X2-s)*(t_m+s-m_d2-2*m_X2)**(3/2)*(t_p+s-m_d2-2*m_X2)**(3/2))) - (32*m_d4*s2*(m_d2-s-t_m)*(m_d2-s-t_p))/(np.sqrt(-a)*m_X4*SQA*(2*m_X2-s)*(t_m+s-m_d2-2*m_X2)**(3/2)*(t_p+s-m_d2-2*m_X2)**(3/2)) - (128*m_d4*s2*(s-m_h2)*(3*m_d4-m_d2*(8*s+3*(t_m+t_p))+5*s2+4*s*(t_m+t_p)+3*t_m*t_p))/(np.sqrt(-a)*gss*m_X2*SQA*(2*m_X2-s)*((m_h2-s)**2+m_Gamma_h2)*(t_m+s-m_d2-2*m_X2)**(3/2)*(t_p+s-m_d2-2*m_X2)**(3/2)) - (64*m_d4*s3*(m_h2-s)*(-m_d2+s+t_m)*(-m_d2+s+t_p))/(np.sqrt(-a)*gss*m_X4*SQA*(2*m_X2-s)*((m_h2-s)**2+m_Gamma_h2)*(t_m+s-m_d2-2*m_X2)**(3/2)*(t_p+s-m_d2-2*m_X2)**(3/2))

    # term3_max = prefac_3' * (-np.log(t_m-t_p))
    # term3_min = prefac_3' * (i*pi - np.log(t_m-t_p))

    # term3_max - term3_min = -i*pi
    # prefac3'*(term3_max - term3_min) = prefac3 * (-pi)
    term3_max_min_diff = prefac_3 * (-np.pi)

    # prefac4 = 1/(i) * prefac3'
    prefac_4 = -((16)/(np.sqrt(-a)*SQA)) + (256*m_d2*(m_h2-s))/(np.sqrt(-a)*gss*SQA*((m_h2-s)**2+m_Gamma_h2)) + (384*m_d2*(s-4*m_d2))/(np.sqrt(-a)*gss2*SQA*((m_h2-s)**2+m_Gamma_h2)) - ((128*m_d2)/(np.sqrt(-a)*m_X2*SQA)) + (32*m_d2*s)/(np.sqrt(-a)*m_X4*SQA) + (128*m_d2*s*(s-m_h2))/(np.sqrt(-a)*gss*m_X2*SQA*((m_h2-s)**2+m_Gamma_h2)) + (128*m_d2*s*(4*m_d2-s))/(np.sqrt(-a)*gss2*m_X2*SQA*((m_h2-s)**2+m_Gamma_h2)) + (64*m_d2*s2*(m_h2-s))/(np.sqrt(-a)*gss*m_X4*SQA*((m_h2-s)**2+m_Gamma_h2)) + (32*m_d2*s2*(s-4*m_d2))/(np.sqrt(-a)*gss2*m_X4*SQA*((m_h2-s)**2+m_Gamma_h2))

    # term4_max = prefac_4' * (np.log(t_m-t_p))
    # term4_min = prefac_4' * (np.log(t_p-t_m))

    # term3_max - term3_min = i*pi
    # prefac4'*(term4_max - term4_min) = prefac4 * (pi)
    term4_max_min_diff = prefac_4 * (np.pi)

    # prefac5 = 1/(i) * prefac5'
    prefac_5 = (32*m_d4*s2)/(m_X4*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p)))

    # term5_max = prefac_5' * np.log(t_m-t_p)
    # term5_max = prefac_5' * np.log(t_p-t_m)

    # term5_max - term5_min = i*pi
    # prefac5'*(term5_max - term5_min) = prefac5 * (pi)
    ...
    if np.any(in_any_neq):
        ...
        # prefac' = 1/(1j)*prefac = (-1j) * prefac

        term2_max_min_diff[in_any_neq] = prefac_2[in_any_neq] * ( (-1j)*((np.log(m_d2-t_max[in_any_neq])-np.log(m_d2*(2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+2*np.sqrt((m_d2-t_m[in_any_neq])*(m_d2-t_p[in_any_neq])*(t_max[in_any_neq]-t_m[in_any_neq])*(t_max[in_any_neq]-t_p[in_any_neq]))-t_max[in_any_neq]*(t_m[in_any_neq]+t_p[in_any_neq])+2*t_m[in_any_neq]*t_p[in_any_neq])) - (np.log(m_d2-t_min[in_any_neq])-np.log(m_d2*(2*t_min[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+2*np.sqrt((m_d2-t_m[in_any_neq])*(m_d2-t_p[in_any_neq])*(t_min[in_any_neq]-t_m[in_any_neq])*(t_min[in_any_neq]-t_p[in_any_neq]))-t_min[in_any_neq]*(t_m[in_any_neq]+t_p[in_any_neq])+2*t_m[in_any_neq]*t_p[in_any_neq]))) ).real

        term3_max_min_diff[in_any_neq] = prefac_3[in_any_neq] * ( (-1j)*((np.log(m_d2+2*m_X2-s[in_any_neq]-t_max[in_any_neq])-np.log(2*np.sqrt(t_max[in_any_neq]-t_m[in_any_neq])*np.sqrt(m_d2+2*m_X2-s[in_any_neq]-t_m[in_any_neq])*np.sqrt((t_max[in_any_neq]-t_p[in_any_neq])*(m_d2+2*m_X2-s[in_any_neq]-t_p[in_any_neq]))+m_d2*(2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+m_X2*(4*t_max[in_any_neq]-2*(t_m[in_any_neq]+t_p[in_any_neq]))+t_p[in_any_neq]*(s[in_any_neq]-t_max[in_any_neq]+2*t_m[in_any_neq])-2*s[in_any_neq]*t_max[in_any_neq]+s[in_any_neq]*t_m[in_any_neq]-t_max[in_any_neq]*t_m[in_any_neq])) - (np.log(m_d2+2*m_X2-s[in_any_neq]-t_min[in_any_neq])-np.log(2*np.sqrt(t_min[in_any_neq]-t_m[in_any_neq])*np.sqrt(m_d2+2*m_X2-s[in_any_neq]-t_m[in_any_neq])*np.sqrt((t_min[in_any_neq]-t_p[in_any_neq])*(m_d2+2*m_X2-s[in_any_neq]-t_p[in_any_neq]))+m_d2*(2*t_min[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+m_X2*(4*t_min[in_any_neq]-2*(t_m[in_any_neq]+t_p[in_any_neq]))+t_p[in_any_neq]*(s[in_any_neq]-t_min[in_any_neq]+2*t_m[in_any_neq])-2*s[in_any_neq]*t_min[in_any_neq]+s[in_any_neq]*t_m[in_any_neq]-t_min[in_any_neq]*t_m[in_any_neq]))) ).real

        term4_max_min_diff[in_any_neq] = prefac_4[in_any_neq] * ( (-1j)*(np.log(2*np.sqrt((t_max[in_any_neq]-t_m[in_any_neq])*(t_max[in_any_neq]-t_p[in_any_neq]))+2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq]) - np.log(2*np.sqrt((t_min[in_any_neq]-t_m[in_any_neq])*(t_min[in_any_neq]-t_p[in_any_neq]))+2*t_min[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])) ).real

        np.log((m_d2*(2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+2*(np.sqrt((m_d2-t_m[in_any_neq])*(m_d2-t_p[in_any_neq])*(t_max[in_any_neq]-t_m[in_any_neq])*(t_max[in_any_neq]-t_p[in_any_neq]))+t_m[in_any_neq]*t_p[in_any_neq])-t_max[in_any_neq]*(t_m[in_any_neq]+t_p[in_any_neq]))/(m_d2-t_max[in_any_neq]))

        term5_max_min_diff[in_any_neq] = prefac_5[in_any_neq] * ( (-1j)*(np.log((m_d2*(2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+2*(np.sqrt((m_d2-t_m[in_any_neq])*(m_d2-t_p[in_any_neq])*(t_max[in_any_neq]-t_m[in_any_neq])*(t_max[in_any_neq]-t_p[in_any_neq]))+t_m[in_any_neq]*t_p[in_any_neq])-t_max[in_any_neq]*(t_m[in_any_neq]+t_p[in_any_neq]))/(m_d2-t_max[in_any_neq])) - np.log((m_d2*(2*t_min[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq])+2*(np.sqrt((m_d2-t_m[in_any_neq])*(m_d2-t_p[in_any_neq])*(t_min[in_any_neq]-t_m[in_any_neq])*(t_min[in_any_neq]-t_p[in_any_neq]))+t_m[in_any_neq]*t_p[in_any_neq])-t_min[in_any_neq]*(t_m[in_any_neq]+t_p[in_any_neq]))/(m_d2-t_min[in_any_neq]))) ).real
...
# Use off-shell propagator
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_Higgs_new(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, m_h, vert, th, m_Gamma_h2):
    """
    Solved for matrix-element and integrated over variable t in collision
    operator using Mathematica, int_Rt |M|^2/sqrt((t-tm)*(t-tp)). 
    These expressions can be found in nu_s_nu_s_to_XX.nb
    ...
    # off-shell propagators. hprop2 != hprop*hprop in PVS-scheme 
    hprop = (s-m_h2)/((s-m_h2)**2 + m_Gamma_h2)
    hprop2 = ((s-m_h2)**2-m_Gamma_h2)/((s-m_h2)**2 + m_Gamma_h2)**2

    # off-shell propagators in CUT-scheme 
    # delta = 1e3*np.sqrt(m_Gamma_h2)
    # x = s-m_h2
    # top_hat_func = (x < delta)*(x > -delta)
    # hprop = (1 - top_hat_func) * 1 / ((s-m_h2 + 1j*m_Gamma_h2))
    ...
    # Anton: Write each term of t-integrated matrix element sorted by denominators, evaluated at t_min and t_max. 
    prefac_1 = -((8*(m_X2-4*m_d2)**2)/(a*(m_d2-t_m)*(m_d2-t_p))) - ((8*(m_X2-4*m_d2)**2)/(a*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)))
    
    term1_max = np.zeros(n) + 0j
    term1_min = np.zeros(n) + 0j

    prefac_2 = -((8*(8*m_d10*(4*m_X2+9*s)+2*m_d8*(52*m_X4-8*m_X2*(9*s+2*(t_m+t_p))-s*(7*s+48*(t_m+t_p)))+2*m_d6*(18*m_X6-m_X4*(121*s+16*(t_m+t_p))+4*m_X2*s*(33*s+19*(t_m+t_p))-2*s*(23*s2+7*s*(t_m+t_p)-6*(t_m2+4*t_m*t_p+t_p2)))+m_d4*(-80*m_X8+2*m_X6*(72*s+37*(t_m+t_p))-m_X4*(76*s2-59*s*(t_m+t_p)+8*(t_m2+20*t_m*t_p+t_p2))+4*m_X2*(2*s3-43*s2*(t_m+t_p)-2*s*(9*t_m2+4*t_m*t_p+9*t_p2)+8*t_m*t_p*(t_m+t_p))+2*s2*(s2+39*s*(t_m+t_p)+29*t_m2+20*t_m*t_p+29*t_p2))+m_d2*(16*m_X10-8*m_X8*(3*s-2*(t_m+t_p))+2*m_X6*(6*s2-24*s*(t_m+t_p)-7*t_m2-60*t_m*t_p-7*t_p2)+m_X4*(-2*s3+28*s2*(t_m+t_p)+s*(23*t_m2+60*t_m*t_p+23*t_p2)+64*t_m*t_p*(t_m+t_p))-4*m_X2*(s2*(t_m2-24*t_m*t_p+t_p2)-2*s*t_m*t_p*(t_m+t_p)+8*t_m2*t_p2)-2*s*(s3*(t_m+t_p)+s2*(t_m2+32*t_m*t_p+t_p2)+22*s*t_m*t_p*(t_m+t_p)+12*t_m2*t_p2))-(2*m_X2-s-t_m)*(2*m_X2-s-t_p)*(2*m_X6*(t_m+t_p)-m_X4*(s*(t_m+t_p)+8*t_m*t_p)-2*s2*t_m*t_p)))/(SQA*(2*m_X2-s)*np.sqrt(-a)*((m_d2-t_m)*(m_d2-t_p))**(3/2)*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p))) + (256*hprop*m_d2*(8*m_d6*(m_X2-s)+m_d4*(30*m_X4-m_X2*(47*s+8*(t_m+t_p))+4*s*(7*s+2*(t_m+t_p)))+m_d2*(24*m_X6-14*m_X4*(4*s+t_m+t_p)+m_X2*(50*s2+23*s*(t_m+t_p)+8*t_m*t_p)-2*s*(11*s2+7*s*(t_m+t_p)+4*t_m*t_p))+m_X2*(2*m_X2-s)*(2*m_X2-s-t_m)*(-2*m_X2+s+t_p)))/(gss*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) - (64*m_d2*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p)))/(m_X2*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (64*m_d4*s2*(m_d2-s-t_m)*(m_d2-s-t_p))/(m_X4*SQA*(2*m_X2-s)*np.sqrt(a*(t_m-m_d2)*(m_d2-t_p))*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (256*hprop*m_d4*s2*(3*m_d4-m_d2*(8*s+3*(t_m+t_p))+5*s2+4*s*(t_m+t_p)+3*t_m*t_p))/(gss*m_X2*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (128*hprop*m_d4*s3*(-m_d2+s+t_m)*(m_d2-s-t_p))/(gss*m_X4*SQA*(2*m_X2-s)*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p))*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p))

    term2_max = np.zeros(n) + 0j 
    term2_min = prefac_2 * np.pi/2 + 0j

    prefac_3 = -((8*(8*m_d6*(12*m_X2-17*s)+2*m_d4*(108*m_X4-8*m_X2*(13*s+4*(t_m+t_p))+s*(55*s+28*(t_m+t_p)))+2*m_d2*(18*m_X6+m_X4*(23*s-20*(t_m+t_p))-4*m_X2*(15*s2+3*s*(t_m+t_p)-4*t_m*t_p)+3*s*(10*s2+7*s*(t_m+t_p)+4*t_m*t_p))-24*m_X8+2*m_X6*(12*s+7*(t_m+t_p))-m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)+4*m_X2*s2*(2*s+t_m+t_p)-2*s2*(s+t_m)*(s+t_p)))/(SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2))) - ((256*hprop*m_d2*(8*m_d6*(m_X2-s)+m_d4*(30*m_X4-m_X2*(47*s+8*(t_m+t_p))+4*s*(7*s+2*(t_m+t_p)))+m_d2*(24*m_X6-14*m_X4*(4*s+t_m+t_p)+m_X2*(50*s2+23*s*(t_m+t_p)+8*t_m*t_p)-2*s*(11*s2+7*s*(t_m+t_p)+4*t_m*t_p))-m_X2*(2*m_X2-s)*(2*m_X2-s-t_m)*(2*m_X2-s-t_p)))/(gss*SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2))) + (64*m_d2*s*(4*m_d6-m_d4*(11*s+4*(t_m+t_p))+m_d2*(6*s2+5*s*(t_m+t_p)+4*t_m*t_p)+s*(s+t_m)*(s+t_p)))/(m_X2*SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2)) - (64*m_d4*s2*(m_d2-s-t_m)*(m_d2-s-t_p))/(m_X4*SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2)) - (256*hprop*m_d4*s2*(3*m_d4-m_d2*(8*s+3*(t_m+t_p))+5*s2+4*s*(t_m+t_p)+3*t_m*t_p))/(gss*m_X2*SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2)) + (128*hprop*m_d4*s3*(m_d2-s-t_m)*(m_d2-s-t_p))/(gss*m_X4*SQA*(2*m_X2-s)*np.sqrt(-a)*((-m_d2-2*m_X2+s+t_m)*(-m_d2-2*m_X2+s+t_p))**(3/2))

    term3_max = np.zeros(n) + 0j
    term3_min = prefac_3 * (-np.pi/2) + 0j

    prefac_4 = -((32*(33*m_d4+m_d2*(36*m_X2-42*s-17*(t_m+t_p))+(2*m_X2-s-t_m)*(2*m_X2-s-t_p)))/(np.sqrt(-a)*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p))) - (512*hprop*m_d2*(m_d4+m_d2*(4*m_X2-4*s-t_m-t_p)+4*m_X4-2*m_X2*(3*s+t_m+t_p)+(2*s+t_m)*(2*s+t_p)))/(np.sqrt(-a)*gss*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) - (256*hprop2*m_d2*(4*m_d2-s)*(3*m_d4+m_d2*(12*m_X2-10*s-3*(t_m+t_p))+12*m_X4-2*m_X2*(8*s+3*(t_m+t_p))+8*s2+5*s*t_m+5*s*t_p+3*t_m*t_p))/(np.sqrt(-a)*gss2*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) - (128*m_d2*(2*m_d4-2*m_d2*(3*s+t_m+t_p)+4*s2+3*s*(t_m+t_p)+2*t_m*t_p))/(np.sqrt(-a)*m_X2*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (64*m_d2*s*(m_d2-s-t_m)*(m_d2-s-t_p))/(np.sqrt(-a)*m_X4*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (256*hprop*m_d2*s*(m_d4-m_d2*(4*s+t_m+t_p)+3*s2+2*s*(t_m+t_p)+t_m*t_p))/(np.sqrt(-a)*gss*m_X2*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) + (128*hprop2*m_d2*s*(4*m_d2-s)*(2*m_d4-2*m_d2*(3*s+t_m+t_p)+4*s2+3*s*(t_m+t_p)+2*t_m*t_p))/(np.sqrt(-a)*gss2*m_X2*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) - (128*hprop*m_d2*s2*(m_d2-s-t_m)*(m_d2-s-t_p))/(np.sqrt(-a)*gss*m_X4*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p)) - (64*hprop2*m_d2*s2*(4*m_d2-s)*(m_d2-s-t_m)*(m_d2-s-t_p))/(np.sqrt(-a)*gss2*m_X4*SQA*(m_d2+2*m_X2-s-t_m)*(m_d2+2*m_X2-s-t_p))

    # term4_max = prefac_4' * np.log(np.sqrt(t_m-t_p)) = 1/2*prefac_4' * np.log(t_m-t_p)
    # term4_min = prefac_4' * np.log(np.sqrt(t_p-t_m)) = 1/2*prefac_4' * np.log(t_p-t_m)
    # term4_max - term4_min = prefac4' * (-i*pi/2)
    # prefac_4' = 1/(i) * prefac_4
    # prefac_4' * (term4_max - term4_min) = prefac_4 * (-np.pi/2)
    term4 = prefac_4 * (-np.pi/2) + 0j
    ...
    if np.any(in_max_neq):
        ...
        term1_max[in_max_neq] = prefac_1[in_max_neq] * np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn))/(m_d2-t_max_xn) + prefac_1[in_max_neq] * np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn))/(m_d2+2*m_X2-s_xn-t_max_xn)

        term2_max[in_max_neq] = prefac_2[in_max_neq] * np.arctan(np.sqrt(((m_d2-t_p_xn)*(t_m_xn-t_max_xn))/((m_d2-t_m_xn)*(t_max_xn-t_p_xn))))

        term3_max[in_max_neq] = prefac_3[in_max_neq] * np.arctan(-(np.sqrt(t_m_xn-t_max_xn)*np.sqrt(-m_d2-2*m_X2+s_xn+t_p_xn))/np.sqrt((t_max_xn-t_p_xn)*(-m_d2-2*m_X2+s_xn+t_m_xn)))
    ...
    if np.any(in_min_neq):
        ...
        term1_min[in_min_neq] = prefac_1[in_min_neq] * np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn))/(m_d2-t_min_mn) + prefac_1[in_min_neq] * np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn))/(m_d2+2*m_X2-s_mn-t_min_mn)

        term2_min[in_min_neq] = prefac_2[in_min_neq] * np.arctan(np.sqrt(((m_d2-t_p_mn)*(t_m_mn-t_min_mn))/((m_d2-t_m_mn)*(t_min_mn-t_p_mn))))

        term3_min[in_min_neq] = prefac_3[in_min_neq] * np.arctan(-(np.sqrt(t_m_mn-t_min_mn)*np.sqrt(-m_d2-2*m_X2+s_mn+t_p_mn))/np.sqrt((t_min_mn-t_p_mn)*(-m_d2-2*m_X2+s_mn+t_m_mn)))

    if np.any(in_any_neq):
        # prefac4' = 1/(1j)*prefac4 = (-1j) * prefac
        term4[in_any_neq] = prefac_4[in_any_neq] * ( (-1j)*(np.log(np.sqrt(t_max[in_any_neq]-t_m[in_any_neq]+0j)+np.sqrt(t_max[in_any_neq]-t_p[in_any_neq])) - np.log(np.sqrt(t_min[in_any_neq]-t_m[in_any_neq]+0j)+np.sqrt(t_min[in_any_neq]-t_p[in_any_neq]))) ).real
    ...
    int_tot = term1 + term2 + term3 + term4
    # print(np.max(np.abs(int_tmax - int_tmin).imag))     # Should be 0.0
...
# Use off-shell propagator
@nb.jit(nopython=True, cache=True)
def ker_C_n_XX_dd_s_t_integral_Higgs_new_no_long(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, m_h, vert, th, m_Gamma_h2):
    """
    Solved for matrix-element and integrated over variable t in collision
    operator using Mathematica, int_Rt |M|^2/sqrt((t-tm)*(t-tp)). 
    These expressions can be found in nu_s_nu_s_to_XX.nb
    ...
    # prefac2' = 1/(i) * prefac_2
    prefac_2 = (-1/(SQA*(2*m_X2-s)*(-a*(m_d2-t_m)*(m_d2-t_p))**(3/2)))*4*a*(48*m_d8+16*m_d6*(4*m_X2-3*(s+t_m+t_p))+2*m_d4*(-20*m_X4+4*m_X2*(3*s+t_m+t_p)+s2+6*s*(t_m+t_p)+24*t_m*t_p)+2*m_d2*(2*m_X6+m_X4*(8*(t_m+t_p)-s)-2*m_X2*(3*s*(t_m+t_p)+20*t_m*t_p)-s*(s*(t_m+t_p)-12*t_m*t_p))-2*m_X6*(t_m+t_p)+m_X4*(s*(t_m+t_p)+8*t_m*t_p)+2*s2*t_m*t_p) - (128*hprop*m_d2*(6*m_d2-m_X2-s))/(gss*SQA*np.sqrt(-a*(m_d2-t_m)*(m_d2-t_p)))

    # term2_max = prefac_2' * (-log(tm-tp))
    # term2_min = prefac_2' * (-i*pi - log(tm-tp))
    # term2_max - term2_min = prefac2' * (i*pi)

    term2 = prefac_2 * np.pi

    # prefac3 = 1/(i) * prefac3'
    prefac_3 = ((4*(48*m_d8-16*m_d6*(2*m_X2+3*(t_m+t_p))+2*m_d4*(-180*m_X4+4*m_X2*(41*s+7*(t_m+t_p))-35*s2-6*s*(t_m+t_p)+24*t_m*t_p)-2*m_d2*(98*m_X6-m_X4*(153*s+64*(t_m+t_p))+m_X2*(72*s2+58*s*(t_m+t_p)+40*t_m*t_p)-s*(10*s2+11*s*(t_m+t_p)+12*t_m*t_p))+24*m_X8-2*m_X6*(12*s+7*(t_m+t_p))+m_X4*(14*s2+7*s*(t_m+t_p)+8*t_m*t_p)-4*m_X2*s2*(2*s+t_m+t_p)+2*s2*(s+t_m)*(s+t_p)))/(np.sqrt(-a)*SQA*(2*m_X2-s)*(-m_d2-2*m_X2+s+t_m)**(3/2)*(-m_d2-2*m_X2+s+t_p)**(3/2))) - (128*hprop*m_d2*(6*m_d2-m_X2-s))/(np.sqrt(-a)*gss*SQA*np.sqrt(-m_d2-2*m_X2+s+t_m)*np.sqrt(-m_d2-2*m_X2+s+t_p))

    # term3_max = prefac3' * log(tm-tp)
    # term3_min = prefac3' * (log(tm-tp) + i*pi)
    # term3_max - term3_min = prefac3' * (-i*pi)
    term3 = prefac_3 * (-np.pi)

    # prefac4 = 1/(i) * prefac4'
    prefac_4 = -((16)/(np.sqrt(-a)*SQA)) - (256*hprop*m_d2)/(np.sqrt(-a)*gss*SQA) + (512*hprop2*m_d2*(s-4*m_d2))/(np.sqrt(-a)*gss2*SQA)

    # term4_max = prefac4' * log(t_m-t_p)
    # term4_min = prefac4' * log(tp-t_m)
    # term4_max - term4_min = prefac4' * (i*pi)
    term4 = prefac_4 * np.pi
    ...
    if np.any(in_max_neq):
        ...
        term1_max[in_max_neq] = (8*(m_X2-6*m_d2)**2*np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn))*(-2*m_d6+m_d4*(-6*m_X2+3*s_xn+2*(t_max_xn+t_m_xn+t_p_xn))-m_d2*(12*m_X4-4*m_X2*(3*s_xn+t_max_xn+t_m_xn+t_p_xn)+3*s_xn**2+2*s_xn*(t_max_xn+t_m_xn+t_p_xn)+2*t_p_xn*(t_max_xn+t_m_xn)+2*t_max_xn*t_m_xn)-8*m_X6+4*m_X4*(3*s_xn+t_max_xn+t_m_xn+t_p_xn)-2*m_X2*(3*s_xn**2+2*s_xn*(t_max_xn+t_m_xn+t_p_xn)+t_max_xn*(t_m_xn+t_p_xn)+t_m_xn*t_p_xn)+t_m_xn*t_p_xn*(s_xn+2*t_max_xn)+s_xn*(s_xn+t_max_xn)*(s_xn+t_m_xn)+s_xn*t_p_xn*(s_xn+t_max_xn)))/(a_xn*(m_d2-t_max_xn)*(m_d2-t_m_xn)*(m_d2-t_p_xn)*(m_d2+2*m_X2-s_xn-t_max_xn)*(m_d2+2*m_X2-s_xn-t_m_xn)*(m_d2+2*m_X2-s_xn-t_p_xn))
    ...
    if np.any(in_min_neq):
        ...
        term1_min[in_min_neq] = (8*(m_X2-6*m_d2)**2*np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn))*(-2*m_d6+m_d4*(-6*m_X2+3*s_mn+2*(t_min_mn+t_m_mn+t_p_mn))-m_d2*(12*m_X4-4*m_X2*(3*s_mn+t_min_mn+t_m_mn+t_p_mn)+3*s_mn**2+2*s_mn*(t_min_mn+t_m_mn+t_p_mn)+2*t_p_mn*(t_min_mn+t_m_mn)+2*t_min_mn*t_m_mn)-8*m_X6+4*m_X4*(3*s_mn+t_min_mn+t_m_mn+t_p_mn)-2*m_X2*(3*s_mn**2+2*s_mn*(t_min_mn+t_m_mn+t_p_mn)+t_min_mn*(t_m_mn+t_p_mn)+t_m_mn*t_p_mn)+t_m_mn*t_p_mn*(s_mn+2*t_min_mn)+s_mn*(s_mn+t_min_mn)*(s_mn+t_m_mn)+s_mn*t_p_mn*(s_mn+t_min_mn)))/(a_mn*(m_d2-t_min_mn)*(m_d2-t_m_mn)*(m_d2-t_p_mn)*(m_d2+2*m_X2-s_mn-t_min_mn)*(m_d2+2*m_X2-s_mn-t_m_mn)*(m_d2+2*m_X2-s_mn-t_p_mn))

    if np.any(in_any_neq):
        # prefac' = 1/(1j)*prefac = (-1j) * prefac

        t_max_an = t_max[in_any_neq]
        t_min_an = t_min[in_any_neq]
        t_m_an = t_m[in_any_neq]
        t_p_an = t_p[in_any_neq]
        s_an = s[in_any_neq]

        term2[in_any_neq] = prefac_2[in_any_neq] * ( (-1j) * ((np.log(m_d2-t_max_an)-np.log(m_d2*(2*t_max_an-t_m_an-t_p_an)+2*np.sqrt((m_d2-t_m_an)*(m_d2-t_p_an)*(t_max_an-t_m_an)*(t_max_an-t_p_an)+0j)-t_max_an*(t_m_an+t_p_an)+2*t_m_an*t_p_an)) - (np.log(m_d2-t_min_an)-np.log(m_d2*(2*t_min_an-t_m_an-t_p_an)+2*np.sqrt((m_d2-t_m_an)*(m_d2-t_p_an)*(t_min_an-t_m_an)*(t_min_an-t_p_an)+0j)-t_min_an*(t_m_an+t_p_an)+2*t_m_an*t_p_an))) ).real

        term3[in_any_neq] = prefac_3[in_any_neq] * ( (-1j) * ((np.log(m_d2+2*m_X2-s_an-t_max_an+0j)-np.log(2*np.sqrt(t_max_an-t_m_an+0j)*np.sqrt(m_d2+2*m_X2-s_an-t_m_an+0j)*np.sqrt((t_max_an-t_p_an)*(m_d2+2*m_X2-s_an-t_p_an)+0j)+m_d2*(2*t_max_an-t_m_an-t_p_an)+m_X2*(4*t_max_an-2*(t_m_an+t_p_an))+t_p_an*(s_an-t_max_an+2*t_m_an)-2*s_an*t_max_an+s_an*t_m_an-t_max_an*t_m_an)) - (np.log(m_d2+2*m_X2-s_an-t_min_an+0j)-np.log(2*np.sqrt(t_min_an-t_m_an+0j)*np.sqrt(m_d2+2*m_X2-s_an-t_m_an+0j)*np.sqrt((t_min_an-t_p_an)*(m_d2+2*m_X2-s_an-t_p_an)+0j)+m_d2*(2*t_min_an-t_m_an-t_p_an)+m_X2*(4*t_min_an-2*(t_m_an+t_p_an))+t_p_an*(s_an-t_min_an+2*t_m_an)-2*s_an*t_min_an+s_an*t_m_an-t_min_an*t_m_an))) ).real

        term4[in_any_neq] = prefac_4[in_any_neq] * ( (-1j) * (np.log(2*np.sqrt((t_max_an-t_m_an)*(t_max_an-t_p_an)+0j)+2*t_max_an-t_m_an-t_p_an) - np.log(2*np.sqrt((t_min_an-t_m_an)*(t_min_an-t_p_an)+0j)+2*t_min_an-t_m_an-t_p_an)) ).real
...
def ker_C_n_XX_dd_s_t_integral(ct_min, ct_max, ct_p, ct_m, a, s, E1, E3, p1, p3, m_d, m_X, vert):
    ...
    # Anton: Making manual simplifications to original terms to make code run faster
    # This includes discarding imaginary contributions to terms (that SHOULD end up cancelling anyways)
    # and only include the real parts of terms that actually contributes
    ...
    # contributions (from sqrt(a)=i*sqrt(-a), a<0 ). Then only count imaginary contributions in terms multiplied by prefac_2
    # prefac_2 defined below is then really prefac_2'
    prefac_2 = -(1/(np.sqrt(-a)*(m_d2-t_m)**(3/2)*(m_d2-t_p)**(3/2)*(2*m_X2-s)))*4*(16*m_d8-16*m_d6*(t_m+t_p)-2*m_d4*(12*m_X4+4*m_X2*(-s+t_m+t_p)+s2-2*s*(t_m+t_p)-8*t_m*t_p)+2*m_d2*(-2*m_X6+m_X4*(s+8*(t_m+t_p))-2*m_X2*(s*(t_m+t_p)-4*t_m*t_p)+s*(s*(t_m+t_p)-4*t_m*t_p))+2*m_X6*(t_m+t_p)-m_X4*(s*(t_m+t_p)+8*t_m*t_p)-2*s2*t_m*t_p)
    ...
    # term4_max = -((16*np.log(t_m-t_p))/np.sqrt(a+0j))
    # term4_min = -((16*np.log(t_p-t_m + 0j))/np.sqrt(a+0j))
    # term4_max - term4_min = 16*pi / sqrt(-a)
    log_part = 16*np.pi / np.sqrt(-a)
    ...
    if np.any(in_max_neq):
        ...
        term1_max[in_max_neq] = -((8*(2*m_d2+m_X2)**2*np.sqrt(a_xn*(t_max_xn-t_m_xn)*(t_max_xn-t_p_xn))*(2*m_d6+m_d4*(6*m_X2-3*s_xn-2*(t_max_xn+t_m_xn+t_p_xn))+m_d2*(12*m_X4-4*m_X2*(3*s_xn+t_max_xn+t_m_xn+t_p_xn)+3*s2_xn+2*s_xn*(t_max_xn+t_m_xn+t_p_xn)+2*t_p_xn*(t_max_xn+t_m_xn)+2*t_max_xn*t_m_xn)+(2*m_X2-s_xn)*(2*m_X2-s_xn-t_max_xn)*(2*m_X2-s_xn-t_m_xn)-t_p_xn*(4*m_X4-2*m_X2*(2*s_xn+t_max_xn+t_m_xn)+s2_xn+s_xn*(t_max_xn+t_m_xn)+2*t_max_xn*t_m_xn)))/(a_xn*(t_max_xn-m_d2)*(t_m_xn-m_d2)*(t_p_xn-m_d2)*(-m_d2-2*m_X2+s_xn+t_max_xn)*(-m_d2-2*m_X2+s_xn+t_m_xn)*(-m_d2-2*m_X2+s_xn+t_p_xn)))

        # *(1j) from redefinition of prefac_2/3 = -i*prefac_2/3'
        term2_max[in_max_neq] = prefac_2[in_max_neq] * (np.log(m_d2-t_max_xn)-np.log(m_d2*(2*t_max_xn-t_m_xn-t_p_xn)+2*np.sqrt(m_d2-t_m_xn)*np.sqrt(m_d2-t_p_xn)*np.sqrt(t_max_xn-t_m_xn+0j)*np.sqrt(t_max_xn-t_p_xn)-t_max_xn*(t_m_xn+t_p_xn)+2*t_m_xn*t_p_xn)*(1j)).real

        term3_max[in_max_neq] = prefac_3[in_max_neq] * (np.log(m_d2+2*m_X2-s_xn-t_max_xn+0j)-np.log(-2*np.sqrt(t_max_xn-t_m_xn+0j)*np.sqrt(t_max_xn-t_p_xn)*np.sqrt(s_xn+t_m_xn-m_d2-2*m_X2)*np.sqrt(s_xn+t_p_xn-m_d2-2*m_X2)+m_d2*(2*t_max_xn-t_m_xn-t_p_xn)+m_X2*(4*t_max_xn-2*(t_m_xn+t_p_xn))+t_p_xn*(s_xn-t_max_xn+2*t_m_xn)-2*s_xn*t_max_xn+s_xn*t_m_xn-t_max_xn*t_m_xn)*(1j)).real

        # term4_max[in_max_neq] = -((16*np.log(2*np.sqrt(t_max_xn-t_m_xn)*np.sqrt(t_max_xn-t_p_xn)+2*t_max_xn-t_m-t_p_xn))/np.sqrt(a_xn))
    ...
    if np.any(in_min_neq):
        ...
        term1_min[in_min_neq] = -((8*(2*m_d2+m_X2)**2*np.sqrt(a_mn*(t_min_mn-t_m_mn)*(t_min_mn-t_p_mn))*(2*m_d6+m_d4*(6*m_X2-3*s_mn-2*(t_min_mn+t_m_mn+t_p_mn))+m_d2*(12*m_X4-4*m_X2*(3*s_mn+t_min_mn+t_m_mn+t_p_mn)+3*s2_mn+2*s_mn*(t_min_mn+t_m_mn+t_p_mn)+2*t_p_mn*(t_min_mn+t_m_mn)+2*t_min_mn*t_m_mn)+(2*m_X2-s_mn)*(2*m_X2-s_mn-t_min_mn)*(2*m_X2-s_mn-t_m_mn)-t_p_mn*(4*m_X4-2*m_X2*(2*s_mn+t_min_mn+t_m_mn)+s2_mn+s_mn*(t_min_mn+t_m_mn)+2*t_min_mn*t_m_mn)))/(a_mn*(t_min_mn-m_d2)*(t_m_mn-m_d2)*(t_p_mn-m_d2)*(-m_d2-2*m_X2+s_mn+t_min_mn)*(-m_d2-2*m_X2+s_mn+t_m_mn)*(-m_d2-2*m_X2+s_mn+t_p_mn)))

        # *(1j) from redefinition of prefac_2/3 = -i*prefac_2/3'
        term2_min[in_min_neq] = prefac_2[in_min_neq] * (np.log(m_d2-t_min_mn)-np.log(m_d2*(2*t_min_mn-t_m_mn-t_p_mn)+2*np.sqrt(m_d2-t_m_mn)*np.sqrt(m_d2-t_p_mn)*np.sqrt(t_min_mn-t_m_mn+0j)*np.sqrt(t_min_mn-t_p_mn)-t_min_mn*(t_m_mn+t_p_mn)+2*t_m_mn*t_p_mn)*(1j)).real

        term3_min[in_min_neq] = prefac_3[in_min_neq] * (np.log(m_d2+2*m_X2-s_mn-t_min_mn)-np.log(-2*np.sqrt(t_min_mn-t_m_mn+0j)*np.sqrt(t_min_mn-t_p_mn)*np.sqrt(s_mn+t_m_mn-m_d2-2*m_X2)*np.sqrt(s_mn+t_p_mn-m_d2-2*m_X2)+m_d2*(2*t_min_mn-t_m_mn-t_p_mn)+m_X2*(4*t_min_mn-2*(t_m_mn+t_p_mn))+t_p_mn*(s_mn-t_min_mn+2*t_m_mn)-2*s_mn*t_min_mn+s_mn*t_m_mn-t_min_mn*t_m_mn)*(1j)).real

        # term4_min[in_min_neq] = -((16*np.log(2*np.sqrt(t_min_mn-t_m_mn)*np.sqrt(t_min_mn-t_p_mn)+2*t_min_mn-t_m_mn-t_p_mn))/np.sqrt(a_mn))

    if np.any(in_any_neq):
        log_part[in_any_neq] = -(((16*np.log(2*np.sqrt(t_max[in_any_neq]-t_m[in_any_neq]+0j)*np.sqrt(t_max[in_any_neq]-t_p[in_any_neq]+0j)+2*t_max[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq]))/np.sqrt(a[in_any_neq]+0j)).real + ((16*np.log(2*np.sqrt(t_min[in_any_neq]-t_m[in_any_neq]+0j)*np.sqrt(t_min[in_any_neq]-t_p[in_any_neq]+0j)+2*t_min[in_any_neq]-t_m[in_any_neq]-t_p[in_any_neq]))/np.sqrt(a[in_any_neq]+0j)).real)
    ...
    # print(vert*(int_tmax - int_tmin).real)
    return vert*(int_tmax - int_tmin + log_part).real
...
# Anton: Needs implementation! 
def C_n_hX_dd(m_d, m_X, m_h, k_d, k_X, k_h, T_d, xi_d, xi_X, xi_h, vert, th, m_Gamma_X2, type=0):
    return 0.
